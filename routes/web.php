...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::get('doi-tac/{id}.html','PageController@detailDoitac')->name('detailDoitac');
    ...
    Route::post('tab-product-home','ProductController@getProductTypeTab')->name('getProductTypeTab');
